package bsu.zlatamigas.webLab67Tomcat9.util.locale;
...
public final class LocalisedMessageKey {
    ...
    public static final String MESSAGE_PRODUCT_NAME_WRONG = "message.product.name.wrong";
    public static final String MESSAGE_PRODUCT_COST_WRONG = "message.product.cost.wrong";
